...
echo "&nbsp;&nbsp;&nbsp;&nbsp;<h1 style=\"marging-left:50px;\">".$_POST['fname'].$_POST['lname']."</h1>";
echo "<p style=\"color:rgb(128,128,128);\">Sukkur Sindh,Pakistan<img style=\"width:18px; height:18px;\" src=\"map.png\"><br/>";
echo "<img style=\"width:18px; height:18px;\" src=\"mail.png\">&nbsp;&nbsp;".$_POST['email']."<br>";
echo "<img style=\"width:21px; height:20px;\" src=\"bd.png\">&nbsp;&nbsp;".$_POST['dob']."<br>";

if($_POST['gender']=='female'){
echo "<img style=\"width:21px; height:20px;\" src=\"female.png\">&nbsp;&nbsp;".$_POST['gender']."<br>";
}
