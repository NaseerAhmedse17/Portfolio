...
<ul class="nav flex-column">
 ...
 <button type="button" class="btn btn-primary">Education <span       class="badge badge-light">5</span>
  ...
  <br>
  <a style="color: white; text-decoration: none;" href="extracricum.php">
  <li class="nav-item">
  <button type="button" class="btn btn-primary">Extra Ciriculum<span class="badge badge-light">&nbsp;3+</span>
</button> 
  </li></a>
  <br>
  <a style="color: white; text-decoration: none;" href="interest.php">
  <li class="nav-item">
...
<p class="lead">
  <blockquote style="color: rgb(178,54,74);" cite="https://www.workitdaily.com/inspirational-career-quotes/ive-missed-more-than-9-000-shots-in-my-career-ive-lost-almost-300-games-26-times-ive-been-trusted-to-take-the-game-winning-shot-and-missed-ive-failed-over-and-over-and-over-again-in-my-life-and-that-i">
    “ Find out what you like doing best and get someone to pay you for doing it."<br>
    <h6>by:Robert kelfore</h6>
    </blockquote>.
</p>
<img width="500px" src="cv.png">
</div>
</div>
