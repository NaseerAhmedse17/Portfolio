...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a class="navbar-brand" href="projects.php">IT Projects<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<h1 class="display-1">IT Projects</h1> 
<p class="lead">
  <blockquote style="color: rgb(178,54,74);" cite="https://www.goodreads.com/quotes/tag/achievement">
    ...
    <h6>by:― Buckminster Fuller</h6>
    </blockquote>.
</p>
<H5 style="color:rgb(178,54,74);"><center>IT Projects List</center></H5>
<?php
...
echo "    <th scope=\"col\">Programming Language</th>";
echo "     <th scope=\"col\">GUI</th>";
echo "   </tr>";
echo " </thead>";
$counter=1;
